...
| Orchestrator/system-only authority for phase advancement/finalization is already enforced across runtime paths. | high | accepted | maintainers | Canonical contract in `Docs/manifest/04_api_contracts.md`; requires additional integration proof in Milestone M1. | Build |
